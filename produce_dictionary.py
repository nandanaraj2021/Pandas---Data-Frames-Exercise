...
print('Highest produce sale: ', produce.loc['Total Sale'].idxmax(), '-', produce.loc['Total Sale'].max())

print('Lowest produce sale: ', produce.loc['Total Sale'].idxmin(), '-', produce.loc['Total Sale'].min())

#print('Highest produce sale: ', produce.loc['Total Sale'].max())

#print('Lowest produce sale: ', produce.loc['Total Sale'].min())
...
print(orange_beets.T)

#3) Using 'loc', display the total sales for 'Apples' through 'Lettuce'
print("-----------------------------------------------   QUESTION THREE   -----------------------------------------------")

apples_lettuce = produce.loc[['Total Sale'], 'Apples':'Lettuce']

print(apples_lettuce.T)
...
print(produce['Apricots'])

#5) What is the average quantity sold across all products? (print out ONLY quantity sold)
print("-----------------------------------------------   QUESTION FIVE   -----------------------------------------------")

print('Average quanity sold for all products: ', produce.loc['Quantity Sold'].mean())

#6) Create a new dataframe for only those produce that have sold between 11,500 to 12,000 (quantity)
print("-----------------------------------------------   QUESTION SIX   -----------------------------------------------")

new_dataframe = produce[(produce > 11500) & (produce < 12000)]

#new_dataframe_02 = new_dataframe.loc['Quantity Sold']

#print(new_dataframe_02.T)
...
print('Total Sales for new dataframe: ', new_dataframe.loc['Total Sale'].sum())